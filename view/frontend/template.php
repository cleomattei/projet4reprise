...
<head>
    ...
    <link href="/public/css/smartphone.css" rel="stylesheet">
    <!-- appel la police d'écriture -->
    <link href="https://fonts.googleapis.com/css?family=Modern+Antiqua|Raleway" rel="stylesheet">
    <link href="https://fonts.googleapis.com/css?family=Shadows+Into+Light" rel="stylesheet">
    <!-- icone -->
    <link rel="icon" src="../../public/images/signature_jean_forteroche_transparent.png"/>
...
<!-- __________________________________________________________________________________________________________________________________________________________________ -->
    <nav class="navbar navbar-expand-md navbar-light bg-light ">
        <a class="navbar-brand" href="index.php?page=jeanForteroche"><img class="img-signature"alt="signature caligraphiée de jean Forteroche" src="../../public/images/signature_jean_forteroche_transparent.png"/></a>
